-- Expand wrath_glory character schema with the full skill set, talents,
-- corruption, speed, psychic powers, and wealth tier — all fields present on
-- an official W&G 2e character sheet that were previously invisible.
